...
function normalizeEnquiryType(typeParam: string | null): string {
  ...
  const found = ENQUIRY_TYPES.find((t) => t.value === normalized);
    ...
    <>
      ...
      {submitted ? (
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          {(enquiryType === "trading" || enquiryType === "mineral-trading") && (
          ...
          {(enquiryType === "mining" || enquiryType === "mining-services") && (
        ...
        <div className="max-w-content mx-auto px-6 md:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            ...
            <div className="lg:col-span-7 bg-iron-white border border-slab-grey p-8 md:p-12">
              <Suspense fallback={<div className="font-mono text-xs text-quarry-grey">Loading enquiry form...</div>}>
                <ContactFormInner />
              </Suspense>
            </div>
          </div>
