...
export const PROJECTS: Project[] = [
  {
    ...
    imageAlt: "Heavy earthmoving machinery constructing an industrial road corridor",
    verified: true,
  ...
  },
  {
    ...
    imageAlt: "Mineral processing plant flotation tanks and pipe infrastructure",
    verified: true,
  ...
  },
  {
    ...
    imageAlt: "Heavy mineral extraction site with sand sorting operations",
    verified: true,
  ...
  },
  {
    ...
    imageAlt: "Industrial workshop bay with heavy machinery under maintenance",
    verified: true,
  ...
  },
  {
    ...
    imageAlt: "Industrial freight rail line through open savanna terrain",
    verified: true,
  ...
  },
  {
    ...
    imageAlt: "Commercial grain storage silos and agro-industrial facility",
    verified: true,
